...
// REGISTRY-CODES: T01:T10 B01:B12 E01:E06 A02.01 A04.01:A04.04 A05.01 A06.01 A06.02 V02 H01
...
function [ids, callbacks, labels, hints] = ld3_button_registry()
    ...
    callbacks = ["ld3_toggle_power()";"ld3_toggle_switch()";"ld3_measure()"; ...
                 ...
                 "ld3_set_voltage(LD3.cfg.U1)";"ld3_set_voltage(LD3.cfg.U2)";"ld3_set_voltage(LD3.cfg.U3)"];
    labels = ["MAITINIMAS";"JUNGLIS";"MATUOTI";"KAIP SUJUNGTI";"STENDO ŽEMĖLAPIS"; ...
              ...
              "NUSTATYTI U1";"NUSTATYTI U2";"NUSTATYTI U3"];
    hints = ["Įjungti/išjungti maitinimo šaltinį.";"Atidaryti/uždaryti jungiklį grandinėje."; ...
             ...
             "Nustatyti šaltinio įtampą į pirmąją instrukcijos reikšmę U1."; ...
             "Nustatyti šaltinio įtampą į antrąją instrukcijos reikšmę U2."; ...
             "Nustatyti šaltinio įtampą į trečiąją instrukcijos reikšmę U3."];
endfunction
