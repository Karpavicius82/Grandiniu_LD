...
// REGISTRY-CODES: T01:T10 B01:B16 E01:E06 A01.01 A02.01 A03.01 A04.01 A05.01:A05.03 A06.01:A06.03 V02 H01
// ============================================================================
...
function [ids, callbacks, labels, hints] = ld12_button_registry()
    ids = ["B01";"B02";"B03";"B04";"B05";"B06";"B07";"B08";"B09";"B10";"B11";"B12";"B13";"B14";"B15";"B16"];
    callbacks = ["ld12_toggle_power()";"ld12_toggle_switch()";"ld12_measure()"; ...
                 ...
                 "ld12_set_phase(1)";"ld12_set_phase(2)";"ld12_set_phase(3)";"ld12_measure_all()";"ld12_set_phase(4)"];
    labels = ["MAITINIMAS";"JUNGIKLIS";"MATUOTI";"KAIP SUJUNGTI";"STENDO ŽEMĖLAPIS"; ...
              "ATKURTI";"PAVYZDYS";"ATASKAITA";"IŠ NAUJO"; ...
              "ŽVAIGŽDĖ";"TRIKAMPIS";"IMTUVAS R1";"IMTUVAS R2";"IMTUVAS R3";"ĮJUNGTI IR MATUOTI VISUS";"LINIJA L1"];
    hints=["Įjungti arba išjungti trifazį šaltinį.";"Bendras visų trijų fazių jungiklis.";"Įrašyti pasirinktą matavimo tašką.";"Numeruota 6 laidų seka.";"Visų numerių paskirtis.";"Atkurti dabartinio etapo sujungimą.";"Pavyzdys nekeičia savo darbo.";"HTML ataskaita dėstytojui.";"Pradėti iš naujo patvirtinus.";"Žvaigždė Y: galai b sujungti su N.";"Trikampis Δ: imtuvai tarp linijų.";"Uf ir If imtuve R1.";"Uf ir If imtuve R2.";"Uf ir If imtuve R3.";"Patikrinti laidus, įjungti ir išmatuoti visus reikalingus taškus.";"Trikampio Ul ir linijinė Il, o ne imtuvo If."];
endfunction
