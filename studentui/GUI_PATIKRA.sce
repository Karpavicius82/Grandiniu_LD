...
try
    ...
    for n=[1 17 64]
        ...
        bench_ld3_workflow(n,root,%t); bench_ld4_workflow(n,root,%t);
    end
    verdict="GUI_PASS: LD1 9, LD2 12, LD3 6 ir LD4 7 etapai, variantai 1/17/64, mygtukų funkcijos, matavimai, duomenų išlaikymas, eksportas";
