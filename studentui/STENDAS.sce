...
if bench_choice==6 then exec(bench_root+"LD6/LD6.sce",-1); end

if bench_choice==7 then exec(bench_root+"LD7/LD7.sce",-1); end

if bench_choice==8 then exec(bench_root+"LD8/LD8.sce",-1); end

if bench_choice==9 then exec(bench_root+"LD9/LD9.sce",-1); end

if bench_choice==10 then exec(bench_root+"LD10/LD10.sce",-1); end

if bench_choice==11 then exec(bench_root+"LD11/LD11.sce",-1); end

if bench_choice==12 then exec(bench_root+"LD12/LD12.sce",-1); end

if bench_choice==13 then exec(bench_root+"DESTYTOJUI.sce",-1); end
