...
function ld2_next()
    ...
    choice=x_choose(["LIKTI IR BAIGTI";"PEREITI NEBAIGUS"], ...
...
function ld2_restart()
    ...
    choice=x_choose(["ATŠAUKTI";"TAIP, PRADĖTI IŠ NAUJO"], ...
...
function ld2_help_current()
    ...
    if step==2 | step==5 | step==8 then
        req=ld2_required_main(ld2_phase_for_step(step));
        lines=["TEISINGI PAGRINDINĖS GRANDINĖS LAIDAI:";ld2_connection_list_text(req)];
    elseif step==4 then
        lines=["RC matavimai:";"A~ jau yra pagrindinėje grandinėje."; ...
          "UR8: V ir COM → R8 M1 ir M2."; ...
          "UC2: V ir COM → C2 M1 ir M2."; ...
          "Ušaltinio: V ir COM → generatoriaus M~ ir M0."; ...
          "Keisdami taikinį spauskite NUIMTI ZONDUS."];
    elseif step==7 then
        lines=["RL matavimai:";"UR9: V ir COM → R9 M1 ir M2."; ...
          "UL1: V ir COM → L1 M1 ir M2."; ...
          "Ušaltinio: V ir COM → generatoriaus M~ ir M0."];
    elseif step==9 | step==11 then
        lines=["V~ prijunkite prie R13 M1 ir M2."; ...
          "Keiskite dažnį. Po kiekvieno keitimo spauskite MATUOTI U."; ...
          "9 etape dar spauskite ĮRAŠYTI TAŠKĄ."; ...
          "11 etape ties slenksčiu įrašykite f1 arba f2."];
    elseif step==10 then
        lines=["UL3: V ir COM → L3 M1 ir M2."; ...
          "UC4: V ir COM → C4 M1 ir M2."; ...
          "|UL3−UC4|: V ir COM → LC1 ir LC2."; ...
          "Tarp taikinių spauskite NUIMTI ZONDUS."; ...
          "Kiekvienam taikiniui keiskite f: MATUOTI U → ĮRAŠYTI TAŠKĄ."; ...
          "UL ir UC ieškokite maksimumo, ULC – minimumo."; ...
          "Kiekvienam turėkite bent 3 dažnius, po tašką abipus ekstremumo."; ...
          "Į laukus nurašykite užfiksuotą maksimumą/minimumą ir jo dažnį."; ...
          "Dažnį galima įvesti tiksliai, pvz., 5032.9 Hz. Pavyzdyje matomos visos trys paieškos."];
    else
        lines=ld2_instruction_lines(step);
    end
    ld2_show_info("Etapo pagalba",lines);
endfunction
