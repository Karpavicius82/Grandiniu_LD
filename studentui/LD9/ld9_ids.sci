...
function [ids, callbacks, labels, hints] = ld9_button_registry()
    ...
    callbacks = ["ld9_toggle_power()";"ld9_toggle_switch()";"ld9_measure()"; ...
                 ...
                 "ld9_set_target(1)";"ld9_set_target(2)";"ld9_set_target(3)";"ld9_set_target(4)";"ld9_measure_all()"];
    labels = ["MAITINIMAS";"JUNGIKLIS";"MATUOTI";"KAIP SUJUNGTI";"STENDO ŽEMĖLAPIS"; ...
              "ATKURTI";"PAVYZDYS";"ATASKAITA";"IŠ NAUJO"; ...
              "0,5·f0";"f0";"2·f0"; ...
              "UR · R";"UL · L";"UC · C";"U · GEN";"VISI 4 MATAVIMAI"];
    hints = ["Įjungti/išjungti generatorių.";"Atidaryti/uždaryti jungiklį."; ...
             ...
             "Voltmetras prie R.";"Voltmetras prie L.";"Voltmetras prie C.";"Voltmetras prie generatoriaus.";"Įjungti grandinę ir įrašyti visus keturis šio etapo matavimus."];
endfunction
