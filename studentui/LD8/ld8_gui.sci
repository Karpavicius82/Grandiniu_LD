...
function ld8_build_gui()
    ...
    labels = ["[A02.01] Rt = R1+R2+R3, Ω";"[A02.02] Re = 1000·U/I, Ω"; ...
        "[A03.01] Rt = 1/(Σ1/R), Ω";"[A03.02] Re = 1000·U/I, Ω"; ...
        "[A04.01] Rt = R1+R2·R3/(R2+R3), Ω";"[A04.02] Re = 1000·U/I, Ω"; ...
        "[A05.01] I1 = 1000·U/R1, mA";"[A05.02] I2 = 1000·U/R2, mA";"[A05.03] I3 = 1000·U/R3, mA"; ...
