# LD10 – lygiagretė RLC grandinė

Paleiskite bendrą `STENDAS.sce` ir pasirinkite LD10 arba atverkite `LD10.sce`.
...
1. Sujunkite aštuonis laidus, spausdami jų galų gnybtus. Seką rodo
...
2. Kiekviename iš trijų matavimo etapų spauskite **Įjungti ir matuoti visus 4**.
   ...
   Norint matuoti atskirai, pasirinkite IR, IL, IC arba I ir spauskite **Matuoti**.
   Kairiojo rodmens antraštė ir paryškintas elementas rodo pasirinktą matavimo vietą.
   Apatinis ampermetras bendrojoje linijoje visada rodo bendrą srovę I.
3. Rezonanso etape įrašykite kokybę Q ir srovių skirtumą. Skaičiavimo etape
   naudokite žurnalo **0,5·f0** tašką. Srovė nurodyta **mA**, įtampa – **V**;
   todėl laidis **Y = I/U**, išreikštas **mS**. Reaktyvioji galia gali būti neigiama.
