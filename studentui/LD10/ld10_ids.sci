...
// REGISTRY-CODES: T01:T12 B01:B17 E01:E06 A01.01 A03.01 A03.02 A05.01:A05.06 A06.01:A06.03 V02 H01
// ============================================================================
...
function name = ld10_terminal_name(id)
    names = ["Generatoriaus + gnybtas";"Generatoriaus − gnybtas"; ...
             ...
             "Ritės L gnybtas a";"Ritės L gnybtas b"; ...
...
function [ids, callbacks, labels, hints] = ld10_button_registry()
    ...
    callbacks = ["ld10_toggle_power()";"ld10_toggle_switch()";"ld10_measure()"; ...
                 ...
                 "ld10_set_target(1)";"ld10_set_target(2)";"ld10_set_target(3)";"ld10_set_target(4)";"ld10_measure_all()"];
    labels = ["MAITINIMAS";"JUNGIKLIS";"MATUOTI";"KAIP SUJUNGTI";"STENDO ŽEMĖLAPIS"; ...
              "ATKURTI";"PAVYZDYS";"ATASKAITA";"IŠ NAUJO"; ...
              "0,5·f0";"f0";"2·f0"; ...
              "IR · R";"IL · L";"IC · C";"I · BENDRA";"Įjungti ir matuoti visus 4"];
    hints = ["Įjungti/išjungti generatorių.";"Atidaryti/uždaryti jungiklį."; ...
             "Užfiksuoti pasirinktos vietos srovę ir bendrą šakų įtampą."; ...
             ...
             "Ampermetras R šakoje.";"Ampermetras L šakoje.";"Ampermetras C šakoje.";"Ampermetras pagrindinėje linijoje.";"Nustatyti etapo dažnį, įjungti grandinę ir įrašyti IR, IL, IC bei I."];
endfunction
