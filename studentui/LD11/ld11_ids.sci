...
// REGISTRY-CODES: T01:T10 B01:B12 E01:E06 A01.01 A02.01:A02.03 A03.01 A05.01:A05.04 A06.01:A06.03 V02 H01
// ============================================================================
...
function name = ld11_terminal_name(id)
    names = ["Generatoriaus + gnybtas";"Generatoriaus − gnybtas"; ...
             ...
             "Ampermetro − gnybtas";"Ritės (R, L) gnybtas a";"Ritės (R, L) gnybtas b"; ...
...
function [ids, callbacks, labels, hints] = ld11_button_registry()
    ...
    hints = ["Įjungti/išjungti generatorių.";"Atidaryti/uždaryti jungiklį."; ...
             ...
             "HTML ataskaita."; ...
             "Pradėti iš naujo."; ...
             "Ritės grandinė be kompensavimo kondensatoriaus.";"Ta pati ritė su lygiagrečiu Ck."; ...
             "Įjungti grandinę ir įrašyti U, I, P į žurnalą."];
