...
with tempfile.TemporaryDirectory(prefix='LD ataskaitos Žąsė ') as temp:
    ...
    assert counts==Counter({('LD1',22,22):64,('LD2',50,50):64,('LD3',15,15):64,('LD4',27,27):64,('LD5',16,16):64,('LD6',25,25):64,('LD7',27,27):64,('LD8',21,21):64,('LD9',28,28):64,('LD10',28,28):64,('LD11',20,20):64,('LD2',48,50):1}),counts
    evidence=dict(status='PASS',platform=os.name,actual_exported_reports=705,
                  ld1_full_variants=64,ld2_full_variants=64,ld3_full_variants=64,ld4_full_variants=64,ld5_full_variants=64,ld6_full_variants=64,ld7_full_variants=64,ld8_full_variants=64,ld9_full_variants=64,ld10_full_variants=64,ld11_full_variants=64,wrong_and_missing_preserved=True,
