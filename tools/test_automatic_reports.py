...
with tempfile.TemporaryDirectory(prefix='LD ataskaitos Žąsė ') as temp:
    ...
    assert counts==Counter({('LD1',22,22):64,('LD2',50,50):64,('LD3',15,15):64,('LD4',27,27):64,('LD5',16,16):64,('LD2',48,50):1}),counts
    evidence=dict(status='PASS',platform=os.name,actual_exported_reports=385,
                  ld1_full_variants=64,ld2_full_variants=64,ld3_full_variants=64,ld4_full_variants=64,ld5_full_variants=64,wrong_and_missing_preserved=True,
