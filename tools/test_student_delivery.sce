...
global LD1 LD2 LD3 LD4 LD5 LD6 LD7 LD8 BENCH_REPORT_WINDOW BENCH_LAST_REPORT DELIVERY_OPEN;
...
try
    ...
    mputl("PASS: seven fixed windows; small-screen scrolling; LD2/LD3 full GUI; report and folder buttons",out+"verdict.log");exit(0);
catch
