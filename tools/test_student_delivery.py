"""Internal feedback: seven consistent windows, compact screens and report actions."""
...
summary=dict(status='PASS',platform=sys.platform,labs=list(range(1,8)),canvas=[1280,720],small_screens=[[1024,768],[900,600]],scrollable=True,report_buttons=3,ld2_ld3_workflows=True)
