...
with zipfile.ZipFile(root / "dist/Grandiniu_LD-studentui.zip") as archive:
    ...
    for name in ["README.md", "LD1/VARIANTAI.csv", "LD2/VARIANTAI.csv", "LD3/VARIANTAI.csv","LD4/VARIANTAI.csv","LD5/VARIANTAI.csv","LD6/VARIANTAI.csv","LD7/VARIANTAI.csv", "capture_window.py"]:
